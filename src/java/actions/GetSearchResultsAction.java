...
public class GetSearchResultsAction extends Action {
    ...
    private static Log log = LogFactory.getLog(GetSearchResultsAction.class);
     ...
     throws Exception
    {
        ...
        String test = request.getParameter("keyphrase");
        log.debug("Test keyphrase is " + test);

        KeyphraseForm f = (KeyphraseForm)form;
        ArrayList keyphrases = new ArrayList();
        // Each checkbox is called keyphrase. THIS MUST BE THE SAME NAME AS THE FORM
        // The form populates an array of strings via the setKeyphrase method
        // Now run through each keyphrase in the array and get the value.
        ...
        {
            log.debug("No keyphrases selected");
        }

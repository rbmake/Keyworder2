    ...
    <form action="">
        ...
        <table border=0 cellspacing="0" cellpadding="5">
            ...
            <tr>
                ...
                <logic:iterate name="RequestRankingMonths" id="Month">
                    <th>
                        <a href="/Keyworder2/secure/ViewRankingsByMonth.do?domainId=<bean:write name="SessionDomain" property="id"/>&month=<bean:write name="Month" property="id"/>"><bean:write name="Month" property="name"/></a>
                    </th>
                </logic:iterate>
            ...
            <logic:iterate name="RequestRankingHistories" id="RankingHistory" >
                ...
                <tr >
                    ...
                    <td class="info" width="70">
                        <a href="javascript:showKeywordRankingsByMonth('Rankings for &quot;<bean:write name='Ranking' property='keyword.name' />&quot;&nbsp;on&nbsp;<bean:write name="Ranking" property="timestamp" format="MMM yy"/>'  , <bean:write name="Ranking" property="keyword.id" />,'<bean:write name="Ranking" property="timestamp" format="MMyyyy"/>')">
